...
if sys.platform.startswith("win32"):
    initial_folder = os.path.expanduser("~\\Documents\\My Games\\FarmingSimulator2022")
elif sys.platform.startswith("darwin"):
    initial_folder = os.path.expanduser("~/Library/Application Support/FarmingSimulator2022")
...
# Create the Window
window = sg.Window('FS22 Vehicle Sorter', layout)
